...
const FAQItem: React.FC<{ question: string; answer: string }> = ({ question, answer }) => {
  ...
  return (
    <div className="border-b border-gray-700 py-4">
      ...
      {isOpen && <p className="mt-2 text-base sm:text-lg text-gray-300 leading-relaxed">{answer}</p>}
    </div>
  );
};
      ...
      <section className="py-12 sm:py-16 px-4 sm:px-8" data-aos="fade-up">
        <div className="max-w-5xl mx-auto text-center">
          <p className="text-base sm:text-lg text-gray-300 leading-relaxed mb-8">
            With over two decades of industry expertise, VIZX Global stands out as a premier specialist
            in outsourced recruitment services. Our extensive experience ensures we source top talent for
      ...
      <section className="py-12 sm:py-16 px-4 sm:px-8 bg-gray-800" data-aos="fade-up">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-base sm:text-lg text-gray-300 leading-relaxed mb-8 text-center">
            We provide flexible staffing solutions including permanent, temporary, contract, and per diem
            placements.
          </p>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              { title: 'Travel Nurse Staffing', text: 'Temporary nurses for short-term assignments across the nation.' },
              { title: 'Locum Tenens Staffing', text: 'Interim placements for physicians and healthcare professionals.' },
              { title: 'Per Diem Nurse Staffing', text: 'Hourly-based staffing to cover unexpected shortfalls.' },
              { title: 'Allied Healthcare Staffing', text: 'Recruitment for allied health professionals including therapists and radiographers.' },
              { title: 'Direct Hire', text: 'Permanent placements with competitive benefits and career growth.' },
            ].map((card, i) => (
      ...
      <section className="py-12 sm:py-16 px-4 sm:px-8" data-aos="fade-up">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mt-8">
            {[
              { title: 'Proven Expertise', text: 'Years of refined recruitment processes ensuring top-tier talent.' },
              { title: 'Tailored Solutions', text: 'Customized staffing strategies to meet your unique requirements.' },
              { title: 'Global Reach, Local Expertise', text: 'A broad network of professionals with localized knowledge.' },
              { title: 'Cost Savings', text: 'Reduce overheads while ensuring quality placements.' },
              { title: 'Cutting-Edge Tech', text: 'Leveraging the latest AI-driven tools for streamlined recruitment.' },
              { title: 'Quality Assurance', text: 'Strict screening processes ensuring high-quality candidate placement.' },
            ].map((card, i) => (
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <form className="space-y-4">
            <div className="flex flex-col md:flex-row md:space-x-4">
              <input type="text" placeholder="Your Name" className="flex-1 p-3 rounded mb-4 md:mb-0 text-black" />
              <input type="text" placeholder="Your Phone Number" className="flex-1 p-3 rounded text-black" />
            </div>
            <div className="flex flex-col md:flex-row md:space-x-4">
              <input type="email" placeholder="Email" className="flex-1 p-3 rounded mb-4 md:mb-0 text-black" />
              <input type="text" placeholder="Company Name" className="flex-1 p-3 rounded text-black" />
            </div>
            <textarea placeholder="How can we help?" className="w-full p-3 rounded text-black" rows={4} />
